...
if __name__ == '__main__':
    ...
    #parameter setting
    output_name = f'{stock_code}_{args.mode}_{rl_method}_{network}'
    is_learning = args.mode in ['train', 'update']
    reuse_model = args.mode in ['test', 'update', 'predict']

    value_network_name = f'{stock_code}_{rl_method}_{network}_value.mdl'
    policy_network_name = f'{stock_code}_{rl_method}_{network}_policy.mdl'
    ...
    value_network_path = f'./models/{value_network_name}'
    policy_network_path = f'./models/{policy_network_name}'
    ...
    chart_data, training_data = load_data('./coca_cola_stock_with_moving_averages.csv', args.start, args.end)
